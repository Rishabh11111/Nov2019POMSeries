...
//	   List<WebElement> elements =wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(footers));
	    List<WebElement> elements = waitForElementsVisible(footers, 10);
